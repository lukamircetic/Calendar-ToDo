<script>
  ...
  // theming variables:
  export let buttonBackgroundColor = '#f7d455'
  export let buttonBorderColor = '#f7d455'
  export let buttonTextColor = '#fff'
  export let highlightColor = '#f7d455'
  export let dayBackgroundColor = '#313036' 
  export let dayTextColor = '#fff'
  export let dayHighlightedBackgroundColor = '#f7d455'
  export let dayHighlightedTextColor = '#fff'
...
<div class="datepicker" class:closing={isClosing} style={wrapperStyle}>
  <Popover
    bind:this={popover}
    bind:open={isOpen}
